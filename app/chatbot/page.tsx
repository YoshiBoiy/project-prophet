...
export default function ChatBot() {
	return (
		<div className="flex flex-col w-[1/2] h-full m-36 text-xl font-sans bg-neutral rounded-xl border-[3px] border-stroke shadow-2xl shadow-stroke">
			<div className="h-full w-full flex flex-col"></div>
			<div className="border-stroke border-t-[3px] rounded-b-xl w-full h-22 p-4">
				<input id="userInput" type="text" placeholder="Ask a question" className="input input-bordered input-stroke w-full shadow-md shadow-stroke rounded-full" />
